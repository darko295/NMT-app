...
function Header()
{
	$this->Image('../img/logo1.png',5,6,35);
	$this->Cell(20);
    // Title
    $this->SetFont('DejaVu','',8);
	$this->Cell(0,8,'Naša mala trgovina doo | Sedište: Vojvode Stepe 251 | Telefon: 011/3545-225 | PIB: 110587966 | Matični broj: 3518645',0,1,'C');
	$this->Ln(2);
...
function Footer()
{
	...
	$this->SetY(-15);
    $this->Cell(150,0,'',0,0,'C');
    $this->SetFont('DejaVu','',7);
    $this->Cell(40,0,'Generisano: '.$date,0,0,'R');
    $this->SetFont('DejaVu','',11);
    $this->Ln(2);
	$this->Cell(190,0,'',1,0,'C');
	$this->Ln(1.5);
    // Page number
	$this->Cell(0,10,'Strana '.$this->PageNo().' od {nb}',0,0,'C');
}
